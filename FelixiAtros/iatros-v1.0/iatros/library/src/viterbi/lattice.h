...
static const arg_module_t lattice_module = { LATTICE_MODULE_NAME, "lattice module",
    {
        {"nbest", ARG_INT, "1", 0, "Number of nbest incoming words to be stored by the final lattice state."
                                   "'1' by default. '0' to indicate infinite nbests"},
        {"nnode", ARG_INT, "-1", 0, "Number of nbest incoming words to be stored per each lattice state."
